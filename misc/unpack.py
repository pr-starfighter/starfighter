...
def unpack(pak):
    ...
    while True:
        ...
        (size,) = struct.unpack(b"<I", full_read(pak, 4))
...
def main(args):
    ...
    except (IOError, OSError, PakException) as e:
        print(e)
